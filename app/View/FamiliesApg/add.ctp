<div class="container">
    <h2><?php echo __('New family APG4'); ?></h2>
    <?php
    echo $this->Form->create('FamilyApg', array('type' => 'post', 'url' => array('controller' => 'familiesApg', 'action' => 'add'),
    ...
    <div class="row submit-panel">
        ...
        <div class="col-md-1 col-xs-6">
            <?php
            echo $this->Html->link(__('Cancel'), '/familiesApg/index', array(
