...
(function ($) {
    ...
    */      
    ...
    '<div class="editable-input input-group"><div class="editable-buttons input-group-btn"></div></div>'+
...
(function ($) {
    ...
    //buttons
    $.fn.editableform.buttons = '<button type="submit" class="btn btn-primary editable-submit"><span class="glyphicon glyphicon-ok"></span></button>'+
                                '<button type="button" class="btn editable-cancel"><span class="glyphicon glyphicon-remove"></span></button>';         
...
(function ($) {
    ...
    $.extend($.fn.editableContainer.Popup.prototype, {
        ...
        innerCss: (typeof $.fn.popover.defaults !== 'undefined') && $($.fn.popover.defaults.template).find('p').length ? '.popover-content p' : '.popover-content',
